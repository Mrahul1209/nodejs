...
module.exports.verifyEmail = async (req, res) => {
    ...
    `
        ...
        req.session.otp = OTP;
        req.session.adminVerifyId = adminVerify.id;
...
module.exports.changePasswordThroughOTP = async (req, res) => {
    try {
        ...
        const adminFound = await admin.findByIdAndUpdate(req.session.adminVerifyId, { password: req.body.newPassword }, { new: true });
        ...
        delete req.session.adminVerifyId;
        return res.redirect('/');
    } catch (err) {
        req.flash('error', "Something went wrong");
        console.log("Something went wrong...");
